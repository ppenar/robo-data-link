from rplidar.pyrplidar_serial import PyRPlidarSerial
from rplidar.pyrplidar_protocol import * 
import rplidar.pyrplidar_protocol
...
class PyRPlidar:
    ...
    def connect(self, port="/dev/ttyUSB0", baudrate=115200, timeout=3):
        ...
        self.lidar_serial.open(port, baudrate, timeout=timeout)
    ...
    def get_info(self):
        ...
        try:
            ...
            raise PyRPlidarConnectionError("Lidar connection error")
